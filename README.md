...
{% hint style="warning" %}
**Important:** This documentation applies to the **latest minor version** (5.0.**X**). For information on new features and supported prerequisites released with each minor version, refer to the relevant release notes available at [get.weka.io](https://get.weka.io/).
...
**Additional protocols:** Learn about the supported protocols—NFS, SMB, and S3—for accessing data stored in a NeuralMesh filesystem.
...
**Monitor the cluster:** Deploy the WEKA Management Server (WMS) alongside tools like Local WEKA Home, and WEKAmon to effectively monitor your cluster.

**Kubernetes**: The Kubernetes guides cover deploying and managing the NeuralMesh. Learn how to use the WEKA Operator for high-performance storage deployment and handle day-2 operations including scaling, hardware management, and performance optimization.
...
**Best practice guides:** Explore our carefully selected guides, starting with NeuralMesh and Slurm integration, to discover expert-recommended strategies and insights for optimizing your system and achieving peak performance in various scenarios.
