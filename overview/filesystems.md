...
<table><thead><tr><th width="159.34501597463696">File size</th><th width="223">Number of metadata units</th><th>Example</th></tr></thead><tbody><tr><td>&#x3C; 0.5 MB</td><td>1</td><td><p>A filesystem with 1 billion files of 64 KB each requires 1 billion metadata units.</p><p></p><p>SSD size = 1 billion * 4 KB = 4 TB<br>RAM size = 1 billion * 20 bytes = 20 GB</p></td></tr><tr><td>0.5 MB - 1 MB</td><td>2</td><td>A filesystem with 1 million files of 750 KB each requires 2 million metadata units.<br><br>SSD size = 2 million * 4 KB = 8 GB<br>RAM size = 2 million * 20 bytes = 40 MB</td></tr><tr><td>> 1 MB</td><td>2 for the first 1 MB plus<br>1 per MB for the rest MBs</td><td><p>Example 1:</p><p>A filesystem with 1 million files of 129 MB each requires 130 million metadata units.<br>2 units for the first 1 MB plus 1 unit per MB for 128 MB.</p><p></p><p>SSD size = 130 million * 4 KB = 520 GB<br>RAM size = 130 million * 20 bytes = 260 MB</p><p></p><p>Example 2:</p><p>A filesystem with 10 million files of 1.5 MB each requires 30 million units.</p><p></p><p>SSD size = 30 million * 4 KB = 120 GB<br>RAM size = 30 million * 20 bytes = 60 MB</p><p></p><p>Example 3:</p><p>A filesystem with 10 million files of 3 MB each requires 40 million units.</p><p></p><p>SSD size = 40 million * 4 KB = 160 GB<br>RAM size = 40 million * 20 bytes = 800 MB</p></td></tr></tbody></table>
