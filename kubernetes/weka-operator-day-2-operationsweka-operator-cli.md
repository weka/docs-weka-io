...
**Phase 1:** [#perform-standard-verification-steps](weka-operator-day-2-operationsweka-operator-cli.md#perform-standard-verification-steps "mention").
...
4. [#perform-the-standard-verification-steps](weka-operator-day-2-operationsweka-operator-cli.md#perform-the-standard-verification-steps "mention").
...
See examples in [#perform-standard-verification-steps](weka-operator-day-2-operationsweka-operator-cli.md#perform-standard-verification-steps "mention").
...
7.  **Verification steps**:&#x20;
    ...
    For details, see [#verification-steps](weka-operator-day-2-operationsweka-operator-cli.md#verification-steps "mention").
...
3. [#perform-the-standard-verification-steps](weka-operator-day-2-operationsweka-operator-cli.md#perform-the-standard-verification-steps "mention").
