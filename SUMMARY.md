...
* [New WEKA CLI (formerly wekactl) overview](getting-started-with-weka/weka-cli-overview/README.md)
  * [Manage WEKA with new CLI](getting-started-with-weka/weka-cli-overview/manage-weka-with-new-cli.md)
  * [Migrate from legacy WEKA CLI](getting-started-with-weka/weka-cli-overview/migrate-from-legacy-weka-cli.md)
  * [CLI reference guide](getting-started-with-weka/weka-cli-overview/cli-reference-guide/README.md)
    * [weka agent](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-agent.md)
    * [weka alerts](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-alerts.md)
    * [weka audit](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-audit.md)
    * [weka catalog](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-catalog.md)
    * [weka cloud](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-cloud.md)
    * [weka cluster](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-cluster.md)
    * [weka completion](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-completion.md)
    * [weka dataservice](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-dataservice.md)
    * [weka diags](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-diags.md)
    * [weka driver](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-driver.md)
    * [weka events](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-events.md)
    * [weka fs](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-fs.md)
    * [weka gui](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-gui.md)
    * [weka help](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-help.md)
    * [weka local](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-local.md)
    ...
    * [weka stats](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-stats.md)
    * [weka status](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-status.md)
    * [weka telemetry](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-telemetry.md)
    * [weka tenant](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-tenant.md)
    * [weka upgrade](getting-started-with-weka/weka-cli-overview/cli-reference-guide/weka-upgrade.md)
...
* [Manage KMS](security/kms-management/README.md)
  * [Manage KMS using the GUI](security/kms-management/kms-management.md)
  * [Manage KMS using the CLI](security/kms-management/kms-management-1.md)
* [Manage TLS certificates](security/tls-certificate-management/README.md)
  * [Manage TLS certificates using the GUI](security/tls-certificate-management/manage-the-tls-certificate-using-the-gui.md)
  * [Manage TLS certificates using the CLI](security/tls-certificate-management/manage-the-tls-certificate-using-the-cli.md)
...
* [Upgrade WEKA versions](operation-guide/upgrading-weka-versions/README.md)
  * [Breaking changes](operation-guide/upgrading-weka-versions/breaking-changes.md)
...
* [WEKA Home - The WEKA support cloud](monitor-the-weka-cluster/the-wekaio-support-cloud/README.md)
  ...
  * [Deploy Local WEKA Home on K8s](monitor-the-weka-cluster/the-wekaio-support-cloud/deploy-local-weka-home-on-k8s/README.md)
    * [Manage remote debugging sessions on K8s](monitor-the-weka-cluster/the-wekaio-support-cloud/deploy-local-weka-home-on-k8s/manage-remote-debugging-sessions-on-k8s.md)
  * [Deploy Local WEKA Home on K3s](monitor-the-weka-cluster/the-wekaio-support-cloud/deploy-local-weka-home-on-k3s/README.md)
    ...
    * [Manage remote debugging sessions on K3s](monitor-the-weka-cluster/the-wekaio-support-cloud/deploy-local-weka-home-on-k3s/manage-remote-debugging-sessions-on-k3s.md)
...
* [WEKA Operator deployments](kubernetes/weka-operator-deployments/README.md)
  ...
  * [Cloud Deployment Manager Kubernetes deployment types](kubernetes/weka-operator-deployments/cloud-deployment-manager-kubernetes-deployment-types/README.md)
