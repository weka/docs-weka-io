...
For more details about the resource generator, see the [#3.-generate-the-resource-files](../install/bare-metal/using-cli.md#3.-generate-the-resource-files "mention") procedure in the _WEKA cluster installation_ topic.
