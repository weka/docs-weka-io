...
description: >-
  ...
  commands, and the related information to learn the theory.
---
...
Related information: [user-management](../usage/user-management/ "mention")
...
Related information: [alerts](../usage/alerts/ "mention")
...
| **Set cloud WEKA Home proxy URL:** Change the URL used to access cloud services.                   | [POST ​/wekaHome​/proxy](https://api.docs.weka.io/#/Weka%20home/setCloudProxy)             | weka cloud proxy --set \<proxy\_url>                           |
...
Related information: [bare-metal](../install/bare-metal/ "mention")
...
Related information: [expanding-and-shrinking-cluster-resources](../usage/expanding-and-shrinking-cluster-resources/ "mention")
...
Related information: [#id-6.-configure-default-data-networking-optional](../install/bare-metal/perform-post-configuration-procedures.md#id-6.-configure-default-data-networking-optional "mention")
...
Related information: [events](../usage/events/ "mention")
...
Related information: [ssd-capacity-management.md](../overview/ssd-capacity-management.md "mention")
...
* [attaching-detaching-object-stores-to-from-filesystems](../fs/attaching-detaching-object-stores-to-from-filesystems/ "mention")
...
Related information: [quota-management](../fs/quota-management/ "mention")
...
Related information: [managing-filesystem-groups](../fs/managing-filesystem-groups/ "mention")
...
| **Add port for all interface groups:** Assign a port to be accessible by the specified interface group.                                         | [POST ​/interfaceGroups​/port](https://api.docs.weka.io/#/Interface%20group/interfaceGroupAddPort)                                            | <p>weka nfs interface-group port add &#x3C;name> <br> &#x3C;server-id> &#x3C;port></p> |

## KMS

Related information: [security](../usage/security/ "mention")
...
Related information: [account-lockout-threshold-policy-management](../usage/security/account-lockout-threshold-policy-management/ "mention")
...
Related information: [obtain-authentication-tokens.md](../usage/security/obtain-authentication-tokens.md "mention")
...
* [#set-mount-option-default-values](../fs/mounting-filesystems.md#set-mount-option-default-values "mention")
...
| **Grant NFS permissions:** Assign permissions for a specific client group to access a designated NFS-mounted filesystem.                                                                  | [POST ​/nfs​/permissions](https://api.docs.weka.io/#/NFS/addNfsPermission)                                    | weka nfs permission add \<fs\_name> \<client-group-name>    |
| **View NFS permissions of a specific filesystem:** See existing access controls for client groups accessing a specific filesystem through NFS.                                            | [GET ​/nfs​/permissions​/{uid}](https://api.docs.weka.io/#/NFS/getNfsPermission)                              | weka nfs permission --filesystem \<fs\_name>                |
| **Modify NFS permissions:** Update existing access controls for client groups using an NFS-mounted filesystem.                                                                            | [PUT ​/nfs​/permissions​/{uid}](https://api.docs.weka.io/#/NFS/updateNfsPermission)                           | weka nfs permission update \<fs\_name> \<client-group-name> |
| **Revoke access:** Remove permissions for client groups to access a designated NFS-mounted filesystem.                                                                                    | [DELETE ​/nfs​/permissions​/{uid}](https://api.docs.weka.io/#/NFS/deleteNfsPermission)                        | weka nfs permission delete \<fs\_name> \<client-group-name> |
...
Related information: [managing-object-stores](../fs/managing-object-stores/ "mention")
...
Related information: [organizations](../usage/organizations/ "mention")
...
Related information: [weka-containers-architecture-overview.md](../overview/weka-containers-architecture-overview.md "mention")
...
Related information: [statistics](../usage/statistics/ "mention")
...
Related information: [perform-post-configuration-procedures.md](../install/bare-metal/perform-post-configuration-procedures.md "mention")
...
Related information: [background-tasks](../usage/background-tasks/ "mention")
...
Related information: [tls-certificate-management](../usage/security/tls-certificate-management/ "mention")
