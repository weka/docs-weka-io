...
| `--color` \<color-mode>         | Whether to use color in output.                                                                                                                                                                                                                      |
...
| `--theme` \<theme>              | Select the default theme to use, which controls the appearance command results.                                                                                                                                                                      |
...
| `--viewer-theme` \<theme>       | Default color theme for the `debug viewer` trace viewer.                                                                                                                                                                                             |
