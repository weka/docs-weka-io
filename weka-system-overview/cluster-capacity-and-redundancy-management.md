...
Individual drives sit below this boundary: losing a drive affects only part of one failure domain, so a cluster survives at least as many simultaneous drive failures as its protection level.
