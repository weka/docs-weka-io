...
* [Restore a filesystem from an uploaded snapshot](snap-to-obj-1.md#restore-a-filesystem-from-an-uploaded-snapshot)
...
Use the following command line to restore (or recreate) a filesystem from an existing snapshot:
