...
To upgrade the cluster to a version higher than the first major release above the client version, see [upgrading-weka-versions.md](../../usage/upgrading-weka-versions.md "mention").
{% endhint %}
