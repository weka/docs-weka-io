...
| `qos_max_throughput_mbps`                | Number           | Maximum requests rate for QoS in megabytes per second. Note, the allows bursting above that limit, but will aim to keep this limit in avarage.                                                                                                                                                                                          | No limit                  | Yes                   |
