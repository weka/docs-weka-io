...
`weka fs create <name> <group-name> <total-capacity> [--ssd-capacity <ssd-capascity>] [--max-files <max-files>] [--filesystem-id <id>] [--encrypted] [--obs-name <obs-name>] [--auth-required auth]`
