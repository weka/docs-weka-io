...
| `auth-required`          | String   | Determines if mounting the filesystem requires to be authenticated to Weka ([weka user login](../../usage/user-management/#user-log-in))                                        | <p><code>yes</code> or <code>no</code><br><br>For a filesystem hosting NFS exports or SMB shares, enabling authentication is not allowed.</p> | No                                                                                                                             | no                                                               |
