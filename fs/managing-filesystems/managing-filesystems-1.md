...
| data-reduction           | Boolean  | Enable data reduction                                                                                                                                                           | Not tired and have a license with data reduction | No                                                                                                                             | No                                                               |
...
| `auth-required`          | String   | Determines if mounting the filesystem requires being authenticated to Weka ([weka user login](../../usage/user-management/#user-log-in))                                        | `yes` or `no`                      | No            | no             |
