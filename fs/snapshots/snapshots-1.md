...
| `preserved-overwritten-snapshot-name`         | String   | <p>A new name for the overwritten snapshot to preserve, thus allowing the IO operations continuity to the filesystem.<br>If not specified, the overwritten snapshot is lost, and IO operations to the filesystem are unavailable.</p> |                               | No            |                                                                                                                                                                                                     |
