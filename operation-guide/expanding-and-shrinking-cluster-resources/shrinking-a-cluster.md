...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/0yXyIrnroN3zIG3qa4W3/operation-guide/expanding-and-shrinking-cluster-resources/shrinking-a-cluster
---
...
To interpret container lifecycle and health during deactivation, see [Container state and status fields](container-state-and-status-fields.md).
