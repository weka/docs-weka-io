...
| ApproachingSystemLimit | Approaching a system limit | {action_item} | MAJOR |
...
| CompressedSpaceFragmented | Compressed free space is too fragmented | Check whether DATA_DEFRAG tasks are paused or hanging. If the issue persists, contact the Customer Success Team. | WARNING |
...
| DriveAutoReactivating | Drive auto-reactivation in progress | Monitor the drive status. {reactivation_action} | WARNING |
