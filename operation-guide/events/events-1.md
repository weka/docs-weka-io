...
`weka events [--num-results num-results] [--start-time <start-time>] [--end-time <end-time>] [--severity severity] [--direction direction] [--fetch-order fetch-order] [--type type-list] [--exclude-type exclude-type-list] [--category category-list] [--cloud-time] [--show-internal] [--raw-units] [--UTC]`
