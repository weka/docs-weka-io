...
FetchLocalStateNoDrainTooLongReport|MAJOR|Process cannot drain local-state changes queue of some overlay children.
...
DpdkInitFailed|MINOR|DPDK initialization fails.
...
HostScanDrivesFailed|MAJOR|Call to host_scan_drives failed.
