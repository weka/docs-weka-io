...
| ReadBlocksImpl\_CAPACITY            | Number of data structures allocated to the ReadBlocksImpl pool                                                                                             | Structs                 |
| ReadBlocksImpl\_STRUCT\_SIZE        | Number of bytes in each struct of the ReadBlocksImpl pool                                                                                                  | Bytes                   |
| ReadBlocksImpl\_USED                | Number of structs in the ReadBlocksImpl pool which are currently being used                                                                                | Structs                 |
