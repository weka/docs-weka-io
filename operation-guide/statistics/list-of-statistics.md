...
ACCEPTED_RELOCATES|Number of relocations accepted by the extent|Blocks/Sec
...
ETERNAL_SINGLES_LEAD_ZEROES|Number of leading zeroes for new eternal single blocks|Zeroes
...
UDP_SENDMSG_PARTIAL_SEND|Number of packets that the system failed to send, but in the same pump, some packets were sent|Packets/Sec
...
AVG_TTFB|Average Time To First Byte|Milliseconds
AVG_TTLB_HIST|Average Time To Last Byte Histogram in Milliseconds |Count
AVG_TTLB_PRECENT|Average Time To Last Byte Percentile in Millisecond|Milliseconds
...
READ_LATENCY|Average latency of READ operations|Microseconds
READ_PARENT_SELINUX_ATTRIBUTE|The number of times we could not get the SELinux attribute from parent|Ops
...
**Type** | **Description** | **Units**
-|-|-
REPORTED_MMAP_ALLOCS|Number of reported mmap alocattions|Allocations
REPORTED_MMAP_ALLOC_MEM|Memory allocated through reportedMmaps, in bytes.|Bytes
REPORTED_MMAP_DEALLOCS|Number of reported mmap dealocattions|Deallocations
...
WRONG_DRIVE_REFS|Reference segments written to the wrong drive|Blocks/Sec
