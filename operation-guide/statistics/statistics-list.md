...
GENERATION_PROPAGATION_AND_APPLY_LATENCY|The duration between when the leader created a ConfigGeneration until a node applies it as its active configuration|Microseconds
...
LOCAL_STATE_BLOCKED_CHANGES|The number of local-state changes that were blocked from propagating to the parent|Blocked LocalState Changes
...
QUEUED_CONFIG_COMMIT_REQUEST|The number of configuration commit requests that await in the queue for RAFT to be available|Commit Requests
...
DS_BACKEND_LOAD_STALL_TIME|Time spent stalling due to high backend load|Seconds/Sec
DS_GET_ATTR_LATENCY|Average latency of getAttr operations|Microseconds
DS_GET_ATTR_OPS|Number of getAttr operations per second|Ops/Sec
DS_LOOKUP_NAME_LATENCY|Average latency of lookupName operations|Microseconds
DS_LOOKUP_NAME_OPS|Number of lookupName operations per second|Ops/Sec
DS_LOOKUP_PATH_LATENCY|Average latency of lookupPath operations|Microseconds
DS_LOOKUP_PATH_OPS|Number of lookupPath operations per second|Ops/Sec
DS_READDIR_LATENCY|Average latency of readdir operations|Microseconds
DS_READDIR_OPS|Number of readdir operations per second|Ops/Sec
DS_RMDIR_LATENCY|Average latency of rmdir operations|Microseconds
DS_RMDIR_OPS|Number of rmdir operations per second|Ops/Sec
DS_UNLINK_FILE_LATENCY|Average latency of unlinkFile operations|Microseconds
DS_UNLINK_FILE_OPS|Number of unlinkFile operations per second|Ops/Sec
...
S3_LIFECYCLE_FILE_DELETION_FAILED_PER_TASK|Number of times file deletion failed during s3 lifecycle task|Files
S3_LIFECYCLE_METADATA_DIR_DELETION_FAILED|Number of times metadata directory deletion failed during s3 lifecycle task|Directories
S3_LIFECYCLE_METADATA_FILE_DELETION_FAILED|Number of times metadata file deletion failed during S3 lifecycle task|Files
S3_LIFECYCLE_TASK_ADD_DIR_ENTRIES|Number of directory entries added for s3 lifecycle task|Ops/Sec
S3_LIFECYCLE_TASK_CREATES|Number of s3 lifecycle tasks created|Ops
S3_LIFECYCLE_TASK_DELETE_DIR_ENTRIES|Number of entries removed for s3 lifecycle task|Ops/Sec
S3_LIFECYCLE_TASK_DELETES|Number of s3 lifecycle tasks removed|Ops
S3_LIFECYCLE_TASK_DIRS_DELETED|Number of directories deleted by the S3 lifecycle task per shard|Directories
S3_LIFECYCLE_TASK_FIBERS|Number of s3 lifecycle task fibers spawned per second|Fibers
S3_LIFECYCLE_TASK_FILES_DELETED_PER_BUCKET|Number of files deleted per s3 bucket|Files/Sec
S3_LIFECYCLE_TASK_FILES_DELETED_PER_TASK|Number of files deleted per s3 lifecycle task|Files/Sec
S3_LIFECYCLE_TASK_FILES_DELETED|Number of files deleted by the S3 lifecycle task per shard|Files/Sec
S3_LIFECYCLE_TASK_FILES_PROCESSED_PER_BUCKET|Number of files processed per s3 bucket|Files/Sec
S3_LIFECYCLE_TASK_FILES_PROCESSED_PER_TASK|Number of files processed per s3 lifecycle task|Files/Sec
S3_LIFECYCLE_TASK_FILES_PROCESSED|Number of files processed by the S3 lifecycle task per shard|Files/Sec
S3_LIFECYCLE_TASK_READDIR_LATENCY|Average latency of s3 lifecycle task readdir operations|Microseconds
S3_LIFECYCLE_TASK_READDIR_OPS|Number of s3 lifecycle task readdir operations per second|Ops/Sec
S3_LIFECYCLE_TASK_RUNTIME|Average runtime of s3 lifecycle task fibers|Microseconds
S3_LIFECYCLE_TASK_TOTAL_DIRS_DELETED|Number of directories deleted by the s3 lifecycle task|Directories
S3_LIFECYCLE_TASK_TOTAL_FILES_DELETED|Number of files deleted by the s3 lifecycle task|Files/Sec
S3_LIFECYCLE_TASK_TOTAL_FILES_PROCESSED|Number of files processed by the s3 lifecycle task|Files/Sec
...
**Type** | **Description** | **Units**
-|-|-
DIR_FIND_IOCTL_OPS|The number of directory find ioctl operations|Ops/Sec
DIR_FIND_IOCTL_PROCESSING_TIME _|The time spent by the directory find ioctl processing directory entries|Microseconds
DIR_FIND_IOCTL_READDIR_OPS|The number of directory find ioctl readdir operations|Ops/Sec
DIR_FIND_IOCTL_READDIR_TIME|The time spent by the directory find ioctl reading directory entries|Microseconds
DIR_FIND_IOCTL_TOTAL_LATENCY|The total time spent by directory find ioctl operations|Microseconds
...
EXECTIME_MAX|Max execution time (usec) of function calls that ran for over the threshold time|Microseconds
...
**Type** | **Description** | **Units**
-|-|-
DIRECT_READ_SIZES_RATE|The number of O_DIRECT reads per read size range per second|Reads
DIRECT_READ_SIZES|The number of O_DIRECT reads per read size range|Reads
DIRECT_WRITE_SIZES_RATE|The number of O_DIRECT writes per read size range per second|Writes
DIRECT_WRITE_SIZES|The number of O_DIRECT writes per read size range|Writes
...
READ_RDMA_SIZES_RATE|The number of RDMA reads per read size range per second|Reads
READ_RDMA_SIZES|The number of RDMA reads per read size range|Reads
READ_SIZES_RATE|The number of reads per read size range per second|Reads
READ_SIZES|The number of reads per read size range|Reads
READDIR_LATENCY|Average latency of READDIR operations|Microseconds
READDIR_OPS|Number of READDIR operations per second|Ops/Sec
...
SINGLE_HOP_WRITE_ATTEMPTS|Number of single hop write attempts per second|Ops/Sec
SINGLE_HOP_WRITE_PUT_BLOCKS_RDMA_FAILURES|Number of putBlock calls per second that failed during single-hop writes due to RDMA failure|Calls/Sec
SINGLE_HOP_WRITE_RDMA_FAILURES|Number of single-hop writes per second that failed due to RDMA failure|Ops/Sec
SINGLE_HOP_WRITE_RETRY_NO_RDMA|Number of single-hop writes per second that were retried without using RDMA|Ops/Sec
SINGLE_HOP_WRITE_SKIPS_DISABLED|Number of single-hop writes per second skipped due to external RDMA configuration|Ops/Sec
SINGLE_HOP_WRITE_SKIPS_EXTERNAL_RDMA|Number of single hop write operation skips (EXTERNAL_RDMA) per second|Ops/Sec
SINGLE_HOP_WRITE_SKIPS_MAX_CONCURRENCY|Number of single-hop writes per second skipped because maximum concurrency was reached|Ops/Sec
SINGLE_HOP_WRITE_SKIPS_PARTIAL_BLOCKS|Number of single-hop writes per second skipped due to partial block writes|Ops/Sec
SINGLE_HOP_WRITE_SKIPS_SMALL_WRITE|Number of single-hop writes per second skipped because the write size was too small|Ops/Sec
SINGLE_HOP_WRITE_SKIPS_UNINIT_CHECKSUM|Number of single-hop writes per second skipped due to uninitialized checksum|Ops/Sec
SINGLE_HOP_WRITE_SKIPS|Number of single-hop write operations per second skipped for any reason|Ops/Sec
SKIPPED_1HOP_READS_DISABLED|Number of single-hop reads per second skipped because the feature is disabled|Ops/Sec
SKIPPED_1HOP_READS_EXTERNAL_RDMA_SPARSE|Number of single-hop reads per second skipped because of sparse read on external RDMA|Ops/Sec
SKIPPED_1HOP_READS_GET_EXTENT_FAILED|Number of single-hop reads per second skipped because the get extent operation failed|Ops/Sec
SKIPPED_1HOP_READS_PARTIAL_READ|Number of single-hop reads per second skipped due to partial read|Ops/Sec
SKIPPED_1HOP_READS_SSD_LOAD|Number of single-hop reads per second skipped due to high drive load|Ops/Sec
SKIPPED_1HOP_READS_TOO_MANY_DESCRIPTORS|Number of single-hop reads per second skipped because of too many descriptors|Ops/Sec
SKIPPED_1HOP_READS_TOO_MANY_DRIVES|Number of single-hop reads per second skipped because of too many drives|Ops/Sec
SKIPPED_1HOP_READS_TOO_SMALL|Number of single-hop reads per second skipped because the IO size is too small|Ops/Sec
STATFS_LATENCY|Average latency of STATFS operations|Microseconds
STATFS_OPS|Number of STATFS operations per second|Ops/Sec
...
THROUGHPUT|Number of bytes read and written per second|Bytes/Sec
UNLINK_LATENCY|Average latency of UNLINK operations|Microseconds
UNLINK_OPS|Number of UNLINK operations per second|Ops/Sec
...
WRITE_RDMA_SIZES_RATE|Number of RDMA writes per second by write size range|Writes
WRITE_RDMA_SIZES|Number of RDMA writes by write size range|Writes
WRITE_SIZES_RATE|Number of writes per second by write size range|Writes
WRITE_SIZES|Number of writes by write size range|Writes
WRITES_NO_LEASE|Number of direct writes per second when no lease is held|Ops/Sec
WRITES|Number of write operations per second|Ops/Sec
...
THROUGHPUT|Number of bytes read and written per second per filesystem|Bytes/Sec
...
CLIENT_ROUNDTRIP_AVG|Round-trip average of client regular and low priority RPC calls|Microseconds
...
CLIENT_USED_NATIVE_FORMAT_FOR_MISSING_REFTYPE|Number of RPCs sent to a node whose reftypes lacked a function|Calls/Sec
...
SERVER_INCOMING_RPCS|Number of incoming RPCs|RPCs
...
STRIPE_DATA_IS_BLOCK_USED|Number of isBlockUsed during s|Occurrencestripe verification|Blocks/Sec
...
WONT_CLEAN_COPYING|Number of actually dirty blocks that ScrubMissingWrites refused to clean because they will be moved to the target anyway|Blocks/Sec
...
DRIVE_UNALIGNED_IOS|Drive unaligned IOs count|IOs
