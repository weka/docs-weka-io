...
* For exact ports and more details refer to [Prerequisites and compatibility](../planning-and-installation/prerequisites-and-compatibility.md#required-ports) section.
