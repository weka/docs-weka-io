...
<div data-with-frame="true"><img src="../.gitbook/assets/login_banner.png" alt="Sign in page with a banner example" width="375"></div>

**Procedure**

1. From the menu, select **Configure > Cluster Settings**.
2. Select **Security**.
3. On the Security page, locate the **Login Banner** area.

<div data-with-frame="true"><img src="../.gitbook/assets/login_banner_set.png" alt="Login banner"></div>

4. Select **Edit banner**.

<div data-with-frame="true"><img src="../.gitbook/assets/login_banner_edit.png" alt="Edit login banner statement"></div>
