...
By default, when a Weka cluster is created, a first user with an `admin` username and a password is created. This user has a Cluster Admin role, which allows the running of all commands.
