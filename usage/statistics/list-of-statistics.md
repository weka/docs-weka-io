...
-|-|-
ASSERTION_FAILURES_IGNORE|Number of times assertion failures with "IGNORE" behavior occurred |Assertion failures
...
CLIENT_NODE_REJOIN_TIME|The number of client rejoin attempts categorized by completion time range|Number of rejoins
...
DELTAS_GC|Number of delta blocks removed by Garbage Collection (GC)|Blocks/Sec
DELTAS_REF_RELOCS|Number of delta blocks notified about reference relocations|Blocks/Sec
DELTA_BACKPTR_COLLISIONS|Number of times delta blocks with the same backptr were encountered during Garbage Collection (GC)|Blocks/Sec
DELTA_PROMOTES|Number of delta blocks promoted by Garbage Collection (GC)|Blocks/Sec
DELTA_RELOCS|Number of delta blocks relocated by Garbage Collection (GC)|Blocks/Sec
...
GC_PROMOTIONS|Number of times data was rewritten to the next Garbage Collection (GC) tree level|Blocks/Sec
...
REFERENCE_GC|Number of reference blocks removed by Garbage Collection (GC)|Blocks/Sec
REFERENCE_PROMOTES|Number of reference blocks promoted by Garbage Collection (GC)|Blocks/Sec
REFERENCE_RELOCS|Number of reference blocks relocated by Garbage Collection (GC)|Blocks/Sec
REF_BACKPTR_COLLISIONS|Number of times where blocks with the same reference-backptr were encountered during Garbage Collection (GC)|Blocks/Sec
...
DEMOTE_EXTENT_OBS_FETCH_BACKPRESSURE|Number of fetch operations per second performed on the extent BACKPRESSURE object stored|Ops/Sec
DEMOTE_EXTENT_OBS_FETCH_IMMEDIATE_RELEASE|Number of fetch operations per second performed on the extent IMMEDIATE_RELEASE object store|Ops/Sec
DEMOTE_EXTENT_OBS_FETCH_MANHOLE|Number of fetch operations per second performed on the extent MANHOLE object store|Ops/Sec
DEMOTE_EXTENT_OBS_FETCH_MIGRATE|Number of fetch operations per second performed on the extent MIGRATE object store|Ops/Sec
DEMOTE_EXTENT_OBS_FETCH_POLICY|Number of fetch operations per second performed on the extent POLICY object store|Ops/Sec
DEMOTE_EXTENT_OBS_FETCH_RECLAMATION_REUPLOAD|Number of fetch operations per second performed on the extent RECLAMATION_REUPLOAD object store|Ops/Sec
DEMOTE_EXTENT_OBS_FETCH_STOW|Number of fetch operations per second performed on the extent STOW object-store|Ops/Sec
DEMOTE_EXTENT_OBS_FETCH|Number of fetch operations per second performed on the extent object store|Ops/Sec
DEMOTE_WAITING_FOR_SLOT|AAverage duration spent waiting for a demotion concurrency slot|Microseconds
...
**Type** | **Description** | **Units**
-|-|-
GC_FREE_SIZE_AFTER_SCAN|Garbage Collection (GC) pool size after the scan ends|Bytes
GC_FREE_SIZE_BEFORE_SCAN|Garbage Collection (GC) pool size before the scan starts|Bytes
GC_SCANS|Number of GC scans|Scans
GC_SCAN_TIME|Garbage Collection (GC) scan time|Msec
GC_USED_SIZE_AFTER_SCAN|Garbage Collection (GC) used size after the scan ends|Bytes
GC_USED_SIZE_BEFORE_SCAN|Garbage Collection (GC) used size before the scan starts|Bytes
...
DROPPED_PACKETS|Number of times packets were received but subsequently dropped|Packets/Sec
ECN_ENCOUNTERED|Number of times ECN Encountered packets were found|Packets/Sec
...
GW_MAC_RESOLVE_FAILURES|Number of times where the ARP was unable to resolve the gateway IP|Failures
GW_MAC_RESOLVE_SUCCESSES|Number of times where the ARP successfully resolved the gateway IP|Successes
INVALID_FIRST_FRAGMENT|Number of times where the first fragment was invalid.|Packets/Sec
MBUF_DUP_COUNT|Numer of duplicate mbufs where found|Occurences
...
PUMPS_TXQ_FULL|Number of times new packets could not be sent to the NIC queue|Pumps/Sec
PUMPS_TXQ_PARTIAL|Number of times only a portion of the queued packets were sent to the NIC queue.|Pumps/Sec
...
RDMA_BINDING_FAILOVERS|Number of times RDMA high-availability failovers occurred|Fail-overs/Sec
...
UDP_SENDMSG_FAILED_EAGAIN|Number of times packets failed to be sent on the socket backend due to an EAGAIN error|Packets/Sec
UDP_SENDMSG_FAILED_OTHER|Number of times packets failed to be sent on the socket backend due to an unknown error|Packets/Sec
UDP_SENDMSG_PARTIAL_SEND|Number of times packets failed to be sent in the same pump where some packets were successfully sent|Packets/Sec
...
KEEPALIVES_NO_LEASE|Number of times driver keepalives were sent while there was no lease|Ops/Sec
LINK_LATENCY|Average latency of LINK operations|Microseconds
LINK_OPS|Number of LINK operations per second|Ops/Sec
...
READS_NO_LEASE|Number of times direct reads were attempted while there was no lease|Ops/Sec
READS|Number of read operations per second|Ops/Sec
READ_BYTES|Number of bytes read per second|Bytes/Sec
...
WRITES_NO_LEASE|Number of times direct writes were attempted while a lease was not present|Ops/Sec
WRITES|Number of write operations per second|Ops/Sec
WRITE_BYTES|Number of byte writes per second|Bytes/Sec
WRITE_DURATION|The number of writes for each time duration|Writes
...
PEER_CONFIGURE_FAILURES|How many times has the node failed to configure peers to sync with them|Peer configure failures
...
MBUF_LIMITED_SLOWDOWN|Number of RPCs slow down due to low MBuf reserves|Ops/Sec
...
ReadBlocksImpl_RAID_CAPACITY|Number of data structures allocated to the ReadBlocksImpl_RAID pool|Structs
ReadBlocksImpl_RAID_STRUCT_SIZE|Number of bytes in each struct of the ReadBlocksImpl_RAID pool|Bytes
ReadBlocksImpl_RAID_USED|Number of structs in the ReadBlocksImpl_RAID pool that are currently being used|Structs
...
DRIVE_STALLS|Number of overlapping IOs stalling progress|IO/Sec
...
SSD_READ_REQS_LARGE_NORMAL|Number of large read requests with normal priority that were received from the SSD service|IO/Sec
...
SSD_WRITES_REQS_LARGE_NORMAL|NNumber of large write requests with normal priority that were sent to the SSD service|IO/Sec
...
NUM_COPY_DISCARDS|Number of times scrubber copy work was discarded|Occurences/Sec
NUM_INVENTED_STRIPES_DISCARDS|Number of times all scrubber work was discarded due to invented stripes|Occurences/Sec
NUM_INVENTED_STRIPES_DISCARD_BLOCKS|Number of blocks that were discarded due to invented stripes|Blocks/Sec
NUM_SCRUBBER_DISCARD_INTERMEDIATES|Number of times all intermediate scrubber work was discarded|Occurences/Sec
NUM_SMW_DISCARDED_BLOCKS|Number of SMW'd blocks that were discarded|Blocks/Sec
NUM_SMW_DISCARDS|Number of times scrubber SMW work was discarded|Occurences/Sec
...
SCAN_LIKELY_LEAKED_BLOCKS|Number of free blocks marked as KnownUsed during the RAID scan|Occurences
SCRUB_BATCHES_LATENCY|Average latency of scrub batches|Millis
SCRUB_FALSE_USED_FAILED_READS|Number of times blocks failed to be read for scrub-false-used|Blocks/Sec
SCRUB_FALSE_USED_FAILED|Number of placements where a full scrub-false-used was not successful|Occurences/Sec
SCRUB_FALSE_USED_PLACEMENTS|Number of placements where scrub-false-used was completed|Occurences/Sec
...
SCRUB_PREPARATION_FAILED|Number of instances where the prepare() function failed, leading to an aborted scrub of placement.|Occurences/Sec
...
UPDATE_PLACEMENT_INFO|Number of times updatePlacementInfo was called|Occurences/Sec
