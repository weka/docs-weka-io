...
| CLIENT\_NODE\_REJOIN\_TIME               | The number of client rejoin attempts categorized by completion time range | Number of rejoins    |
...
| DELTAS\_COMPLETE\_RELOCS            | Number of delta blocks notified about relocation of both delta and ref segments at the same time             | Blocks/Sec   |
| DELTAS\_GC                          | Number of delta blocks removed by Garbage Collection (GC)                                                    | Blocks/Sec   |
| DELTAS\_REF\_RELOCS                 | Number of delta blocks notified about reference relocations                                                  | Blocks/Sec   |
| DELTA\_BACKPTR\_COLLISIONS          | Number of times delta blocks with the same backptr were encountered during Garbage Collection (GC)           | Blocks/Sec   |
| DELTA\_PROMOTES                     | Number of delta blocks promoted by Garbage Collection (GC)                                                   | Blocks/Sec   |
| DELTA\_RELOCS                       | Number of delta blocks relocated by Garbage Collection (GC)                                                  | Blocks/Sec   |
...
| GC\_PROMOTIONS                      | Number of times data was rewritten to the next Garbage Collection (GC) tree level                            | Blocks/Sec   |
...
| REFERENCE\_GC                       | Number of reference blocks removed by Garbage Collection (GC)                                                | Blocks/Sec   |
| REFERENCE\_PROMOTES                 | Number of reference blocks promoted by Garbage Collection (GC)                                               | Blocks/Sec   |
| REFERENCE\_RELOCS                   | Number of reference blocks relocated by Garbage Collection (GC)                                              | Blocks/Sec   |
| REF\_BACKPTR\_COLLISIONS            | Number of times where blocks with the same reference-backptr were encountered during Garbage Collection (GC) | Blocks/Sec   |
...
| DEMOTE\_EXTENT\_OBS\_FETCH\_BACKPRESSURE          | Number of fetch operations per second performed on the extent BACKPRESSURE object stored         | Ops/Sec            |
| DEMOTE\_EXTENT\_OBS\_FETCH\_IMMEDIATE\_RELEASE    | Number of fetch operations per second performed on the extent IMMEDIATE\_RELEASE object store    | Ops/Sec            |
| DEMOTE\_EXTENT\_OBS\_FETCH\_MANHOLE               | Number of fetch operations per second performed on the extent MANHOLE object store               | Ops/Sec            |
| DEMOTE\_EXTENT\_OBS\_FETCH\_MIGRATE               | Number of fetch operations per second performed on the extent MIGRATE object store               | Ops/Sec            |
| DEMOTE\_EXTENT\_OBS\_FETCH\_POLICY                | Number of fetch operations per second performed on the extent POLICY object store                | Ops/Sec            |
| DEMOTE\_EXTENT\_OBS\_FETCH\_RECLAMATION\_REUPLOAD | Number of fetch operations per second performed on the extent RECLAMATION\_REUPLOAD object store | Ops/Sec            |
| DEMOTE\_EXTENT\_OBS\_FETCH\_STOW                  | Number of fetch operations per second performed on the extent STOW object-store                  | Ops/Sec            |
| DEMOTE\_EXTENT\_OBS\_FETCH                        | Number of fetch operations per second performed on the extent object store                       | Ops/Sec            |
| DEMOTE\_WAITING\_FOR\_SLOT                        | AAverage duration spent waiting for a demotion concurrency slot                                  | Microseconds       |
...
| OBS\_RECLAMATION\_WAIT\_FOR\_DESTAGE              | Average time waiting for destaging on space reclamation                                          | Microseconds       |
...
| STOW\_SERIALIZED\_EXTENT\_REDIRECTS               | Number of extent descriptors uploaded that redirect to the previous snapshot                     | Extent Descriptors |
...
| UNEXPECTED\_BLOCK\_VERSION\_POST\_UPGRADE         | Number of unexpected block versions found after the upgrade completed                            | Occurrences        |
...
| **Type**                     | **Description**                                          | **Units** |
| ---------------------------- | -------------------------------------------------------- | --------- |
| GC\_FREE\_SIZE\_AFTER\_SCAN  | Garbage Collection (GC) pool size after the scan ends    | Bytes     |
| GC\_FREE\_SIZE\_BEFORE\_SCAN | Garbage Collection (GC) pool size before the scan starts | Bytes     |
| GC\_SCANS                    | Number of GC scans                                       | Scans     |
| GC\_SCAN\_TIME               | Garbage Collection (GC) scan time                        | Msec      |
| GC\_USED\_SIZE\_AFTER\_SCAN  | Garbage Collection (GC) used size after the scan ends    | Bytes     |
| GC\_USED\_SIZE\_BEFORE\_SCAN | Garbage Collection (GC) used size before the scan starts | Bytes     |
...
| DROPPED\_PACKETS                     | Number of times packets were received but subsequently dropped                                                      | Packets/Sec       |
| ECN\_ENCOUNTERED                     | Number of times ECN Encountered packets were found                                                                  | Packets/Sec       |
...
| GW\_MAC\_RESOLVE\_FAILURES           | Number of times where the ARP was unable to resolve the gateway IP                                                  | Failures          |
| GW\_MAC\_RESOLVE\_SUCCESSES          | Number of times where the ARP successfully resolved the gateway IP                                                  | Successes         |
| INVALID\_FIRST\_FRAGMENT             | Number of times where the first fragment was invalid.                                                               | Packets/Sec       |
| MBUF\_DUP\_COUNT                     | Numer of duplicate mbufs where found                                                                                | Occurences        |
...
| PUMPS\_TXQ\_FULL                     | Number of times new packets could not be sent to the NIC queue                                                      | Pumps/Sec         |
| PUMPS\_TXQ\_PARTIAL                  | Number of times only a portion of the queued packets were sent to the NIC queue.                                    | Pumps/Sec         |
...
| RDMA\_BINDING\_FAILOVERS             | Number of times RDMA high-availability failovers occurred                                                           | Fail-overs/Sec    |
...
| UDP\_SENDMSG\_FAILED\_EAGAIN         | Number of times packets failed to be sent on the socket backend due to an EAGAIN error                              | Packets/Sec       |
| UDP\_SENDMSG\_FAILED\_OTHER          | Number of times packets failed to be sent on the socket backend due to an unknown error                             | Packets/Sec       |
| UDP\_SENDMSG\_PARTIAL\_SEND          | Number of times packets failed to be sent in the same pump where some packets were successfully sent                | Packets/Sec       |
...
| TOTAL\_BUCKET\_DELETE\_OPS            | Total bucket delete operation per second             | Ops/Sec      |
...
| KEEPALIVES\_NO\_LEASE                 | Number of times driver keepalives were sent while there was no lease                | Ops/Sec      |
| LINK\_LATENCY                         | Average latency of LINK operations                                                  | Microseconds |
| LINK\_OPS                             | Number of LINK operations per second                                                | Ops/Sec      |
...
| READS\_NO\_LEASE                      | Number of times direct reads were attempted while there was no lease                | Ops/Sec      |
| READS                                 | Number of read operations per second                                                | Ops/Sec      |
| READ\_BYTES                           | Number of bytes read per second                                                     | Bytes/Sec    |
...
| WRITES\_NO\_LEASE                     | Number of times direct writes were attempted while a lease was not present          | Ops/Sec      |
| WRITES                                | Number of write operations per second                                               | Ops/Sec      |
| WRITE\_BYTES                          | Number of byte writes per second                                                    | Bytes/Sec    |
| WRITE\_DURATION                       | The number of writes for each time duration                                         | Writes       |
...
| PEER\_CONFIGURE\_FAILURES | How many times has the node failed to configure peers to sync with them | Peer configure failures |
...
| ReadBlocksImpl\_RAID\_USED          | Number of structs in the ReadBlocksImpl\_RAID pool that are currently being used                                                                           | Structs                 |
...
| SSD\_READ\_REQS\_LARGE\_NORMAL       | Number of large read requests with normal priority that were received from the SSD service | IO/Sec         |
...
| SSD\_WRITES\_REQS\_LARGE\_NORMAL     | NNumber of large write requests with normal priority that were sent to the SSD service     | IO/Sec         |
...
| NUM\_COPY\_DISCARDS                     | Number of times scrubber copy work was discarded                                                                     | Occurences/Sec |
| NUM\_INVENTED\_STRIPES\_DISCARDS        | Number of times all scrubber work was discarded due to invented stripes                                              | Occurences/Sec |
| NUM\_INVENTED\_STRIPES\_DISCARD\_BLOCKS | Number of blocks that were discarded due to invented stripes                                                         | Blocks/Sec     |
| NUM\_SCRUBBER\_DISCARD\_INTERMEDIATES   | Number of times all intermediate scrubber work was discarded                                                         | Occurences/Sec |
| NUM\_SMW\_DISCARDED\_BLOCKS             | Number of SMW'd blocks that were discarded                                                                           | Blocks/Sec     |
| NUM\_SMW\_DISCARDS                      | Number of times scrubber SMW work was discarded                                                                      | Occurences/Sec |
...
| READ\_BLOCKS\_LATENCY                   | Average latency of reading blocks                                                                                    | Micros         |
...
| SCAN\_LIKELY\_LEAKED\_BLOCKS            | Number of free blocks marked as KnownUsed during the RAID scan                                                       | Occurences     |
| SCRUB\_BATCHES\_LATENCY                 | Average latency of scrub batches                                                                                     | Millis         |
| SCRUB\_FALSE\_USED\_FAILED\_READS       | Number of times blocks failed to be read for scrub-false-used                                                        | Blocks/Sec     |
| SCRUB\_FALSE\_USED\_FAILED              | Number of placements where a full scrub-false-used was not successful                                                | Occurences/Sec |
| SCRUB\_FALSE\_USED\_PLACEMENTS          | Number of placements where scrub-false-used was completed                                                            | Occurences/Sec |
...
| SCRUB\_PREPARATION\_FAILED              | Number of instances where the prepare() function failed, leading to an aborted scrub of placement.                   | Occurences/Sec |
...
| UPDATE\_PLACEMENT\_INFO                 | Number of times updatePlacementInfo was called                                                                       | Occurences/Sec |
