...
| **Type**                                          | **Description**                                                                 | **Units**          |
| ------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------ |
| BACKPRESSURED\_BUCKETS\_IN\_FSS                   | Number of back pressured buckets                                                | Buckets            |
| CONCURRENT\_DEMOTES                               | Number of demotes executed concurrently                                         | Demotes            |
| DEMOTE\_EXTENT\_OBS\_FETCH\_BACKPRESSURE          | Number of extents BACKPRESSURE object-store fetch operations per second         | Ops/Sec            |
...
| DEMOTE\_EXTENT\_OBS\_FETCH\_MANHOLE               | Number of extents MANHOLE object-store fetch operations per second              | Ops/Sec            |
| DEMOTE\_EXTENT\_OBS\_FETCH\_MIGRATE               | Number of extents MIGRATE object-store fetch operations per second              | Ops/Sec            |
| DEMOTE\_EXTENT\_OBS\_FETCH\_POLICY                | Number of extents POLICY object-store fetch operations per second               | Ops/Sec            |
...
| DEMOTE\_EXTENT\_OBS\_FETCH\_STOW                  | Number of extents STOW object-store fetch operations per second                 | Ops/Sec            |
| DEMOTE\_EXTENT\_OBS\_FETCH                        | Number of extents object-store fetch operations per second                      | Ops/Sec            |
...
| RAID\_CHUNKS\_CLEANED\_BY\_SHIFT             | Dirty chunks cleaned by shifting out                                   | Occurences |
...
| WRONG\_DRIVE\_DELTAS                         | Delta segments written to a wrong drive                                | Blocks/Sec |
| WRONG\_DRIVE\_REFS                           | Reference segments are written to a wrong drive                        | Blocks/Sec |
...
| BACKGROUND\_FIBERS                  | Number of background fibers ready to run and eager to get CPU cycles                                                                                       | Fibers                  |
...
| BucketInvocationState\_USED         | Number of structs in the BucketInvocationState pool currently used                                                                                         | Structs                 |
...
| Bucket\_USED                        | Number of structs in the Bucket pool currently used                                                                                                        | Structs                 |
...
| CLASS\_BLOB\_RAID\_USED             | Number of structs in the CLASS\_BLOB\_RAID pool currently used                                                                                             | Structs                 |
...
| ChainedSpan\_USED                   | Number of structs in the ChainedSpan pool currently used                                                                                                   | Structs                 |
...
| Charter\_USED                       | Number of structs in the Charter pool currently used                                                                                                       | Structs                 |
...
| CrossDestageDesc\_USED              | Number of structs in the CrossDestageDesc pool currently used                                                                                              | Structs                 |
| DEFUNCT\_FIBERS                     | Number of defunct buffers. These are memory structures allocated for future fiber needs                                                                    | Fibers                  |
...
| DeferredTask2\_USED                 | Number of structs in the DeferredTask2 pool currently used                                                                                                 | Structs                 |
...
| GenericBaseBlock\_USED              | Number of structs in the GenericBaseBlock pool currently used                                                                                              | Structs                 |
...
| ObsBucketManagement\_USED           | Number of structs in the ObsBucketManagement pool currently used                                                                                           | Structs                 |
...
| ObsGateway\_USED                    | Number of structs in the ObsGateway pool currently used                                                                                                    | Structs                 |
...
| QueuedBlock\_USED                   | Number of structs in the QueuedBlock pool currently used                                                                                                   | Structs                 |
...
| ReadBlocksImpl\_RAID\_USED          | Number of structs in the ReadBlocksImpl\_RAID pool currently used                                                                                          | Structs                 |
| SCHEDULED\_FIBERS                   | Number of current fibers ready to run and eager to get CPU cycles                                                                                          | Fibers                  |
...
| SSD\_USED                           | Number of structs in the SSD pool currently used                                                                                                           | Structs                 |
...
| TimedCallback\_USED                 | Number of structs in the TimedCallback pool currently used                                                                                                 | Structs                 |
...
| UploadFileInfo\_USED                | Number of structs in the UploadFileInfo pool currently used                                                                                                | Structs                 |
| networkBuffers\_CAPACITY            | Number of data structures allocated to the networkBuffers pool                                                                                             | Structs                 |
| networkBuffers\_USED                | Number of structs in the networkBuffers pool currently used                                                                                                | Structs                 |
| rdmaNetworkBuffers\_CAPACITY        | Number of data structures allocated to the rdmaNetworkBuffers pool                                                                                         | Structs                 |
| rdmaNetworkBuffers\_USED            | Number of structs in the rdmaNetworkBuffers pool currently used                                                                                            | Structs                 |
...
| SCAN\_LIKELY\_LEAKED\_BLOCKS            | Number of free blocks encountered during a scan, marked as KnownUsed in the RAID                                     | Occurences     |
