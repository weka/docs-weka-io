...
**Type** | **Description** | **Units**
-|-|-
BACKPRESSURED_BUCKETS_IN_FSS|Number of back pressured buckets|Buckets
CONCURRENT_DEMOTES|Number of demotes executed concurrently|Demotes
DEMOTE_EXTENT_OBS_FETCH_BACKPRESSURE|Number of extents BACKPRESSURE object-store fetch operations per second|Ops/Sec
...
DEMOTE_EXTENT_OBS_FETCH_MANHOLE|Number of extents MANHOLE object-store fetch operations per second|Ops/Sec
DEMOTE_EXTENT_OBS_FETCH_MIGRATE|Number of extents MIGRATE object-store fetch operations per second|Ops/Sec
DEMOTE_EXTENT_OBS_FETCH_POLICY|Number of extents POLICY object-store fetch operations per second|Ops/Sec
...
DEMOTE_EXTENT_OBS_FETCH_STOW|Number of extents STOW object-store fetch operations per second|Ops/Sec
DEMOTE_EXTENT_OBS_FETCH|Number of extents object-store fetch operations per second|Ops/Sec
...
RDMA_CANCELED_COMPLETIONS|Number of RDMA completions that were cancelled|Completions/Sec
RDMA_CLIENT_BINDING_INVALIDATIONS|Number of RDMA client binding invalidations|Invalidations/Sec
RDMA_COMPLETIONS|Number of RDMA requests that completed|Completions/Sec
RDMA_COMP_DURATION|Histogram of RDMA completion duration times|Requests
RDMA_COMP_FAILURES|Number of RDMA requests that completed with an error|Failures/Sec
...
TIME_TO_ACK|Histogram of time to ack a data packet|Requests
...
READ_BYTES|Number of bytes read per second|Bytes/Sec
READ_LATENCY|Average latency of READ operations|Microseconds
READ_OPS|Number of READ operation per second|Ops/Sec
REMOVE_LATENCY|Average latency of REMOVE operations|Microseconds
REMOVE_OPS|Number of REMOVE operation per second|Ops/Sec
RENAME_LATENCY|Average latency of RENAME operations|Microseconds
RENAME_OPS|Number of RENAME operation per second|Ops/Sec
...
WRITE_BYTES|Number of byte writes per second|Bytes/Sec
WRITE_LATENCY|Average latency of WRITE operations|Microseconds
WRITE_OPS|Number of WRITE operation per second|Ops/Sec
...
RAID_CHUNKS_CLEANED_BY_SHIFT|Dirty chunks cleaned by shifting out|Occurences
...
WRONG_DRIVE_DELTAS|Delta segments written to a wrong drive|Blocks/Sec
WRONG_DRIVE_REFS|Reference segments are written to a wrong drive|Blocks/Sec
...
BACKGROUND_FIBERS|Number of background fibers ready to run and eager to get CPU cycles|Fibers
...
BucketInvocationState_USED|Number of structs in the BucketInvocationState pool currently used|Structs
...
Bucket_USED|Number of structs in the Bucket pool currently used|Structs
...
CLASS_BLOB_RAID_USED|Number of structs in the CLASS_BLOB_RAID pool currently used|Structs
...
ChainedSpan_USED|Number of structs in the ChainedSpan pool currently used|Structs
...
Charter_USED|Number of structs in the Charter pool currently used|Structs
...
CrossDestageDesc_USED|Number of structs in the CrossDestageDesc pool currently used|Structs
DEFUNCT_FIBERS|Number of defunct buffers. These are memory structures allocated for future fiber needs|Fibers
...
DeferredTask2_USED|Number of structs in the DeferredTask2 pool currently used|Structs
...
GenericBaseBlock_USED|Number of structs in the GenericBaseBlock pool currently used|Structs
...
ObsBucketManagement_USED|Number of structs in the ObsBucketManagement pool currently used|Structs
...
ObsGateway_USED|Number of structs in the ObsGateway pool currently used|Structs
...
QueuedBlock_USED|Number of structs in the QueuedBlock pool currently used|Structs
...
ReadBlocksImpl_RAID_USED|Number of structs in the ReadBlocksImpl_RAID pool currently used|Structs
SCHEDULED_FIBERS|Number of current fibers ready to run and eager to get CPU cycles|Fibers
...
SSD_USED|Number of structs in the SSD pool currently used|Structs
...
TimedCallback_USED|Number of structs in the TimedCallback pool currently used|Structs
...
UploadFileInfo_USED|Number of structs in the UploadFileInfo pool currently used|Structs
networkBuffers_CAPACITY|Number of data structures allocated to the networkBuffers pool|Structs
networkBuffers_USED|Number of structs in the networkBuffers pool currently used|Structs
rdmaNetworkBuffers_CAPACITY|Number of data structures allocated to the rdmaNetworkBuffers pool|Structs
rdmaNetworkBuffers_USED|Number of structs in the rdmaNetworkBuffers pool currently used|Structs
...
SCAN_LIKELY_LEAKED_BLOCKS|Number of free blocks encountered during a scan, marked as KnownUsed in the RAID|Occurences
