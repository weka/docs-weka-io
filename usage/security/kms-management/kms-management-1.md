...
| [`namespace`](#user-content-fn-1)[^1] | The vault's namespace name.                         | Namespace names must not end with "/", avoid spaces, and refrain from using reserved names like `root`, `sys`, `audit`, `auth`, `cubbyhole`, and `identity`.                                                                                                                                                                                                                                                            |
