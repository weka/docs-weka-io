---
description: >-
  Detailed workflow for configuring the WEKA cluster using the resource
  generator.
metaLinks:
  alternates:
    - >-
...
# Run resources generator

Use this workflow to manually configure the cluster with the resources generator when you are not using the WEKA Configurator.
