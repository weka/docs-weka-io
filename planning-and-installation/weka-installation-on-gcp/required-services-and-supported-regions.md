...
{% hint style="info" %}
If the region you want to deploy in is not on the supported list, verify the availability of these services in that region. If they are available and your region is not listed, contact the WEKA [Customer Success Team](../../support/getting-support-for-your-weka-system.md#open-a-support-case) for validation.
{% endhint %}
