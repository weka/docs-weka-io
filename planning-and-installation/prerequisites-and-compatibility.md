...
For custom kernel certification, contact the [Customer Success Team](https://docs.weka.io/support/getting-support-for-your-weka-system#contact-customer-success-team).
{% endtab %}
