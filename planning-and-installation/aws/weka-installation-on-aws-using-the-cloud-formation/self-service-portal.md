...
{% hint style="info" %}
**Note:** CloudFormation should only be used for initial deployment. To expand cluster resources, refer to [Expanding & Shrinking Cluster Resources](../../../operation-guide/expanding-and-shrinking-cluster-resources/).
{% endhint %}
