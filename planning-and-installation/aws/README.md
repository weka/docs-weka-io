...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/0yXyIrnroN3zIG3qa4W3/planning-and-installation/aws
---
...
* **Create AWS Placement Groups:** Create Cluster Placement Groups to reduce network latency between WEKA servers. This configuration prioritizes performance over resilience and may reduce fault tolerance in the event of hardware failures.
