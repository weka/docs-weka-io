...
If required, you can pause or abort a snapshot upload using the commands described in the [background tasks](../../operation-guide/background-tasks/#pause-resume-abort-a-background-task) section.
