...
{% hint style="info" %}
**Caution :** This script is not optimized for scale. Running it on large filesystems (terabyte or petabyte scale) may cause severe performance degradation, timeouts, or unresponsiveness.
{% endhint %}
