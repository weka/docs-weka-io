...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/0yXyIrnroN3zIG3qa4W3/weka-filesystems-and-object-stores/snapshots
---
...
To access the hidden `.snapshots` directory, see [#access-the-.snapshots-directory](snapshots-1.md#access-the-.snapshots-directory "mention").
