...
#### Set maximum VFs for Intel E810 and Broadcom P2100/2200 NICs

Support for configuring the maximum number of VFs on **stateless** and **stateful** clients is available for Intel E810 and Broadcom P2100/2200 NICs. By default, the system may create an excessive number of VFs. To address this, specify the desired maximum number of VFS using the `-o net` mount option. For example, `-o net=bcm0/vfs@8`.
