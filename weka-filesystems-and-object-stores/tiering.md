...
<div data-with-frame="true"><figure><img src="../.gitbook/assets/obs_reclaim_space (1).png" alt=""><figcaption><p>Object store space reclamation</p></figcaption></figure></div>
...
* **RECLAIMABLE%:** The reclaimable space expressed as a percentage of the total consumed capacity.
* **RECLAIMABLE THRESHOLD%:** The average level (10%) at which automatic reclamation activates. Reclamation specifically begins when reclaimable space exceeds 13% and stops when it drops below 7%.
...
| Tag            | Description                                                                                                                  |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `wekaBlobType` | The internal type representation of the object.Possible values: `DATA`, `METADATA`, `METAMETADATA`, `LOCATOR`, `RELOCATIONS` |
| `wekaFsId`     | A unique filesystem identifier combining the filesystem ID and the cluster GUID.                                             |
| `wekaGuid`     | The cluster GUID.                                                                                                            |
| `wekaFsName`   | The name of the filesystem that uploaded the object.                                                                         |
