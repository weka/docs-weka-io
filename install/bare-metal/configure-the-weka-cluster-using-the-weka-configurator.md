...
* **System preparation is validated:** Ensure the system preparation is validated using the `wekachecker` (on WSA installations this is already installed under /opt/tools/install). See [#id-9.-validate-the-system-preparation](setting-up-the-hosts/#id-9.-validate-the-system-preparation "mention").&#x20;
