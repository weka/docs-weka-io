...
1. [Install the WEKA software on each server](weka-legacy-system-installation-process.md#1.-install-the-weka-software-on-each-server)
2. [Create a cluster from the containers](weka-legacy-system-installation-process.md#2.-create-a-cluster-from-the-containers)
3. [Set a name for the cluster (optional)](weka-legacy-system-installation-process.md#3.-set-a-name-for-the-cluster-optional)
4. [Enable event notifications to the cloud (optional)](weka-legacy-system-installation-process.md#4.-enable-event-notifications-to-the-cloud-optional)
5. [Set containers dedicated to the cluster (optional)](weka-legacy-system-installation-process.md#5.-set-containers-dedicated-to-the-cluster-optional)
6. [Configure the networking](weka-legacy-system-installation-process.md#6.-configure-the-networking)
7. [Configure the SSDs](weka-legacy-system-installation-process.md#7.-configure-the-ssds)
8. [Configure the CPU resources](weka-legacy-system-installation-process.md#8.-configure-the-cpu-resources)
9. [Configure the memory (optional)](weka-legacy-system-installation-process.md#9.-configure-the-memory-optional)
10. [Configure failure domains (optional)](weka-legacy-system-installation-process.md#10.-configure-failure-domains-optional)
11. [Configure WEKA system protection scheme (optional)](weka-legacy-system-installation-process.md#11.-configure-weka-system-protection-scheme-optional)
12. [Configure hot spare (optional)](weka-legacy-system-installation-process.md#12.-configure-hot-spare-optional)
13. [Apply containers configuration](weka-legacy-system-installation-process.md#13.-apply-containers-configuration)
14. [Verify the containers configuration](weka-legacy-system-installation-process.md#14.-verify-the-containers-configuration)
15. [Set a license](weka-legacy-system-installation-process.md#15.-set-a-license)
16. [Run the Start IO command](weka-legacy-system-installation-process.md#16.-run-the-start-io-command)
17. [Bypass the proxy server](weka-legacy-system-installation-process.md#17.-bypass-the-proxy-server)
...
See [#14.-bypass-the-proxy-server](using-cli.md#14.-bypass-the-proxy-server "mention").
