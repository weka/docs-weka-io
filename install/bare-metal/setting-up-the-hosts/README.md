...
The WekaIO system manages the NUMA balancing itself and makes the best possible decisions. Therefore, disable the numa balancing feature of the Linux kernel to avoid additional latencies on the operations.
