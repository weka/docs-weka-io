...
{% hint style="info" %}
**Important Notes Concerning Backward Incompatibility Changes**
...
On 31/Aug/2018, the `/v` and `/aws/cfn` APIs will be discontinued. Consequently, it is necessary to switch to the new APIs described below before this date.
{% endhint %}
