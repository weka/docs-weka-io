...
* The cluster user configured in the plugin's API secret must have a role that permits editing and deleting NFS permissions. This requires WEKA 6.0, or 5.1.28 and later.
