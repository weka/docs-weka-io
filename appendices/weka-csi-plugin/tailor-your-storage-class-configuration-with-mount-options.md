...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/0yXyIrnroN3zIG3qa4W3/appendices/weka-csi-plugin/tailor-your-storage-class-configuration-with-mount-options
---
...
1.  **Create StorageClass:**
    ...
    <pre class="language-yaml" data-overflow="wrap"><code class="lang-yaml">apiVersion: storage.k8s.io/v1
    kind: StorageClass
    metadata:
