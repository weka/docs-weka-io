...
* Access the Web Status GUI to view the snapshot schedules, upload and download queue, locator IDs for successfully uploaded snapshots, and logs. The default URL is `http://<snaptool server hostname/IP>:8090`.
...
* 2 cores
* 8 GB RAM
* 5 GB /opt/ partition (for SnapTool manager installation)
