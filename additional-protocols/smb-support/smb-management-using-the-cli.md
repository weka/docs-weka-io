...
{% hint style="info" %}
The `--smb-ips` parameter must accept the public IPs that the SMB cluster exposes. To mount the SMB cluster in an high-availability manner, clients must be mounted through one of the exposed public IPs, thereby ensuring that they automatically reconnects if one of the SMB containers fails.
{% endhint %}
...
<table><thead><tr><th width="308">Name</th><th>Value</th></tr></thead><tbody><tr><td></td><td></td></tr><tr><td><code>share-id</code>*</td><td>The ID of the share to remove.</td></tr></tbody></table>
