...
| `default-domain-mapping-from-id` | Number                       | The last ID of the range for the default AD ID mapping (for trusted domains that have no range defined).                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Not supported in SMB-W                                                                                                                                                                                                    | No                                                   | 4290000000                               |
...
| `config-fs-name`                 | String                       | The filesystem used for persisting SMB cluster-wide configuration.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Relevant only if`--smbw` is set                                                                                                                                                                                           | <p>SMB-W: Yes<br><br>Legacy SMB: not applicable.</p> |                                          |
...
| `smbw`                           | Boolean                      | <p>SMB-W cluster type.<br>To create an SMB-W cluster, include <code>--smbw</code> in the create cluster command.<br><code></code>Once the SMB-W cluster is created, changing the cluster type is not available.</p>                                                                                                                                                                                                                                                                                                                                                             | None                                                                                                                                                                                                                      | SMB-W: Yes                                           |                                          |
