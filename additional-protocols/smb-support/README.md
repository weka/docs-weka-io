...
{% hint style="info" %}
To deploy SMB-W on Kubernetes with the WEKA Operator, see [Set up protocols on K8s with WEKA Operator](https://app.gitbook.com/s/ZW262oqYA8pNNfGvXjHa/kubernetes/weka-operator-deployments/set-up-protocols-on-k8s-with-weka-operator).
{% endhint %}
