...
| `all-servers`         | Boolean                         | Use all backend servers to serve S3 commands.                                                                                  | None                                                                       | Either `all-servers` or a list of `containers-id` must be provided | Off                                                               |
| `containers-id`       | Comma-separated list of Numbers | Container IDs of containers with a frontend process to serve the S3 service.                                                   | Specify a minimum of 3 containers                                          | Either `all-servers` or a list of `containers-id` must be provided |                                                                   |
