...
* **Firewall rules:**   The WMS listens on multiple ports depending on which service you are accessing.  See [#required-ports](../planning-and-installation/prerequisites-and-compatibility/#required-ports "mention")
